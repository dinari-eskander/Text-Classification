...
Original file is located at
    https://colab.research.google.com/drive/1dhux_DkSOZ79-SwR242NW3qciznYlD6Q
...
df = pd.read_csv("/content/drive/My Drive/train.txt",
                 delimiter=';', header=None, names=['sentence','label'])

val_df = pd.read_csv("/content/drive/My Drive/val.txt",
                 delimiter=';', header=None, names=['sentence','label'])

ts_df = pd.read_csv("/content/drive/My Drive/test.txt",
                 delimiter=';', header=None, names=['sentence','label'])
